...
def test_native_tx_priority(ethermint: Ethermint):
    ...
    test_cases = [
        {
            ...
            "amount": "1000alevi",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}alevi",
        ...
        },
        {
            ...
            "amount": "1000alevi",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}alevi",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("alevi"))
